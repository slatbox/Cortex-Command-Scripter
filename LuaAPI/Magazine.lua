---## Class
---An Attachable ammo magazine that can hold rounds that can be fired by HDFirearm:s.
Magazine = {}
...
---
Magazine.HitWhatTerrMaterial = nil
------------------------------Properties------------------------------
...
function Magazine:IsAttached()end
---### From Parent Class:Attachable
---### Description:
---
...
---
---Whether it's attached or not.
function Magazine:IsAttachedTo(p1)end
---### From Parent Class:Attachable
---### Description:
---
...
function Magazine:IsDrawnAfterParent()end
---### From Parent Class:Attachable
---### Description:
---
...
function Magazine:TransferJointForces(p1)end
---### From Parent Class:Attachable
---### Description:
---
...
function Magazine:TransferJointImpulses(p1)end
---### From Parent Class:Attachable
---### Description:
---
...
function Magazine:CollectDamage()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:AddRecoil()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:SetRecoil(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:IsRecoiled()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:EnableDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:ForceDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:GibThis(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function Magazine:MoveOutOfTerrain(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:ApplyForces()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:ApplyImpulses()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:AttachEmitter(p1,p2,p3,p4)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function Magazine:RemoveWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function Magazine:IsOnScenePoint(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:EraseFromTerrain()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---String value.
function Magazine:GetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Number (double) value.
function Magazine:GetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Object (Entity *) value.
function Magazine:GetObjectValue()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:SetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function Magazine:SetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function Magazine:SetObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:RemoveStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:RemoveNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function Magazine:RemoveObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function Magazine:StringValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function Magazine:NumberValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function Magazine:ObjectValueExists(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function Magazine:SetNextFrame()end
---### From Parent Class:MOSprite
---### Description:
---
...
function Magazine:IsTooFast()end
---### From Parent Class:MOSprite
---### Description:
---
...
function Magazine:RotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
---Takes a vector which is offset from the center of this when not rotated or flipped, and then rotates and/or flips it
...
---
---The resulting vector whihch has been flipped and rotated as appropriate.
function Magazine:UnRotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function Magazine:GetSpriteWidth(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function Magazine:GetSpriteHeight(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:ReloadScripts()end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:GetAltitude(p1,p2)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function Magazine:SetWhichMOToNotHit(p1,p2,p3)end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:IsSetToDelete()end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:IsMissionCritical()end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:IsGeneric()end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:IsDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:IsHeldDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:IsThrownDevice()end
---### From Parent Class:MovableObject
---### Description:
---
---Indicates whether this MO is made of Gold or not.
...
function Magazine:HasObject(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:HasObjectInGroup(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function Magazine:AddForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds force to this MovableObject for the next time Update() is called.
...
---
---None.
function Magazine:AddAbsForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function Magazine:AddImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds impulse force (or instant momentum) to this MovableObject for the next time Update() is called.
...
---
---None.
function Magazine:AddAbsImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function Magazine:ClearForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function Magazine:ClearImpulseForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function Magazine:RestDetection()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function Magazine:NotResting()end
---### From Parent Class:MovableObject
---### Description:
---
...
function Magazine:IsAtRest()end
---### From Parent Class:SceneObject
---### Description:
---
...
function Magazine:GetGoldValue(p1,p2,p3,p4)end
---### From Parent Class:SceneObject
---### Description:
---
...
---
---None.
function Magazine:SetGoldValue(p1)end
---### From Parent Class:SceneObject
---### Description:
---
...
function Magazine:GetGoldValueString(p1,p2,p3)end
---### From Parent Class:SceneObject
---### Description:
---
...
function Magazine:GetTotalValue(p1,p2,p3)end
---### Description
---Create a new Magazine object in specific module by its present name.
 ---### Arguments:
 ---		present_name: its present name.
 ---		moudle_name: specify the module the object from."All" for not specified 
---### Return Value:
---		the new object
function CreateMagazine(present_name,module_name) return Magazine end
---### Description
---Create a new Magazine object randomly in specific group and module.
 ---### Arguments:
 ---		group_name_name: the specific group.
 ---		moudle_name: specify the module the object from."All" for not specified
---### Return Value:
 ---		the new object
function RandomMagazine(group_name,module_name) return Magazine end
---### Description
---Clone a Magazine object.
 ---### Arguments:
 ---		object:the object to clone.
 ---### Return Value:
 ---		the cloned object
function CloneMagazine(object) return Magazine end
---### Description
---cast a object to Magazine object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToMagazine(object) return Magazine end
---### Description
---cast a object to Magazine const object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToConstMagazine(object) return Magazine end
---### Description
---tell whether the type of an object is Magazine type.
 ---### Arguments:
 ---		object:the object.
 ---### Return Value:
 ---		boolean
function IsMagazine(object) end
