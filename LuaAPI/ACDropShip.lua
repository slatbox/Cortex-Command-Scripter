---## Class
---A hovering craft, with two engines on each attached on each end which tilt independently of the body to achieve
---    steering.
ACDropShip = {}
...
---
ACDropShip.ClassName = nil
---
---    The right side engine.
---    An AEmitter pointer.
---
ACDropShip.RightEngine = nil
---
---    The left side engine.
---    An AEmitter pointer.
---
ACDropShip.LeftEngine = nil
---
---    The right side secondary thruster.
---    An AEmitter pointer.
---
ACDropShip.RightThruster = nil
---
---    The left side secondary thruster.
---    An AEmitter pointer.
---
ACDropShip.LeftThruster = nil
---
---    The left side hatch.
---    An Attachable pointer.
---
ACDropShip.LeftHatch = nil
---
---    The right side hatch.
---    An Attachable pointer.
---
ACDropShip.RightHatch = nil
---
---    Get max engine rotation angle in degrees.
---    Max engine angle in degrees.
---
ACDropShip.MaxEngineAngle = nil
---
---    The abstract rate of LateralControl change. Default is 6
---    Current lateral control speed value.
---
ACDropShip.LateralControlSpeed = nil
------------------------------Properties------------------------------
...
---
ACDropShip.ImpulseDamageThreshold = nil
---### From Parent Class:Actor
---
...
---
ACDropShip.AimDistance = nil
---### From Parent Class:Actor
---
---    Actor's sight distance.
---
ACDropShip.SightDistance = nil
---### From Parent Class:Actor
---
---    Returns total number of wounds of this actor.
---
ACDropShip.TotalWoundCount = nil
---### From Parent Class:Actor
---
---    Returns total wound limit of this actor.
---
ACDropShip.TotalWoundLimit = nil
------------------------------Properties------------------------------
...
---    bounds!
---
ACDropShip.BoundingBox = nil
---### From Parent Class:MOSprite
---
---    The number of frames in this MOSprite's animation.
---    The frame count.
---
ACDropShip.FrameCount = nil
---### From Parent Class:MOSprite
---
...
---
ACDropShip.GlobalAccScalar = nil
---### From Parent Class:MovableObject
---
...
---
ACDropShip.HitWhatTerrMaterial = nil
------------------------------Properties------------------------------
...
function ACDropShip:GetAltitude(p1,p2)end
---### From Parent Class:ACraft
---### Description:
---
...
---
---None.
function ACDropShip:OpenHatch()end
---### From Parent Class:ACraft
---### Description:
---
...
---
---None.
function ACDropShip:CloseHatch()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:GetController()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:IsPlayerControlled()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:IsControllable()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:SetControllerMode(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:SwapControllerModes(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:GetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:SetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:HasObject(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:HasObjectInGroup(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:IsWithinRange(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:AddHealth(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:IsStatus(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:IsDead()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:FacingAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:AddAISceneWaypoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:AddAIMOWaypoint(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:ClearAIWaypoints()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:GetLastAIWaypoint()end
---### From Parent Class:Actor
---### Description:
---
...
---
---How many waypoints.
function ACDropShip:GetWaypointListSize()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:ClearMovePath()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:AddToMovePathBeginning(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:AddToMovePathEnd(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:RemoveMovePathBeginning()end
---### From Parent Class:Actor
---### Description:
---
...
---
---Whether there was any coordinate to remove. If false, the MovePath is empty.
function ACDropShip:RemoveMovePathEnd()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None..
function ACDropShip:AddInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:RemoveInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:SwapNextInventory(p1,p2,p3)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:SwapPrevInventory(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:DropAllInventory()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:IsInventoryEmpty()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:FlashWhite(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:DrawWaypoints(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:SetMovePathToUpdate()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:UpdateMovePath(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACDropShip:SetAlarmPoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:GetAlarmPoint()end
---### From Parent Class:Actor
---### Description:
---
...
function ACDropShip:RemoveAnyRandomWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:AddRecoil()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:SetRecoil(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:IsRecoiled()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:EnableDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:ForceDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:GibThis(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACDropShip:MoveOutOfTerrain(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:ApplyForces()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:ApplyImpulses()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:AttachEmitter(p1,p2,p3,p4)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACDropShip:RemoveWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACDropShip:IsOnScenePoint(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:EraseFromTerrain()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---String value.
function ACDropShip:GetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Number (double) value.
function ACDropShip:GetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Object (Entity *) value.
function ACDropShip:GetObjectValue()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:SetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ACDropShip:SetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ACDropShip:SetObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:RemoveStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:RemoveNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACDropShip:RemoveObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACDropShip:StringValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ACDropShip:NumberValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ACDropShip:ObjectValueExists(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACDropShip:SetNextFrame()end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACDropShip:IsTooFast()end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACDropShip:RotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
---Takes a vector which is offset from the center of this when not rotated or flipped, and then rotates and/or flips it
...
---
---The resulting vector whihch has been flipped and rotated as appropriate.
function ACDropShip:UnRotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACDropShip:GetSpriteWidth(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACDropShip:GetSpriteHeight(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:ReloadScripts()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACDropShip:SetWhichMOToNotHit(p1,p2,p3)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsSetToDelete()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsMissionCritical()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsGeneric()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsActor()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsHeldDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsThrownDevice()end
---### From Parent Class:MovableObject
---### Description:
---
---Indicates whether this MO is made of Gold or not.
...
---
---Whether this MovableObject is of Gold or not.
function ACDropShip:IsGold()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACDropShip:AddForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds force to this MovableObject for the next time Update() is called.
...
---
---None.
function ACDropShip:AddAbsForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACDropShip:AddImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds impulse force (or instant momentum) to this MovableObject for the next time Update() is called.
...
---
---None.
function ACDropShip:AddAbsImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACDropShip:ClearForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACDropShip:ClearImpulseForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACDropShip:RestDetection()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACDropShip:NotResting()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACDropShip:IsAtRest()end
---### From Parent Class:SceneObject
---### Description:
---
...
function ACDropShip:GetGoldValue(p1,p2,p3,p4)end
---### From Parent Class:SceneObject
---### Description:
---
...
---
---None.
function ACDropShip:SetGoldValue(p1)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ACDropShip:GetGoldValueString(p1,p2,p3)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ACDropShip:GetTotalValue(p1,p2,p3)end
---### Description
---Create a new ACDropShip object in specific module by its present name.
 ---### Arguments:
 ---		present_name: its present name.
 ---		moudle_name: specify the module the object from."All" for not specified 
---### Return Value:
---		the new object
function CreateACDropShip(present_name,module_name) return ACDropShip end
---### Description
---Create a new ACDropShip object randomly in specific group and module.
 ---### Arguments:
 ---		group_name_name: the specific group.
 ---		moudle_name: specify the module the object from."All" for not specified
---### Return Value:
 ---		the new object
function RandomACDropShip(group_name,module_name) return ACDropShip end
---### Description
---Clone a ACDropShip object.
 ---### Arguments:
 ---		object:the object to clone.
 ---### Return Value:
 ---		the cloned object
function CloneACDropShip(object) return ACDropShip end
---### Description
---cast a object to ACDropShip object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToACDropShip(object) return ACDropShip end
---### Description
---cast a object to ACDropShip const object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToConstACDropShip(object) return ACDropShip end
---### Description
---tell whether the type of an object is ACDropShip type.
 ---### Arguments:
 ---		object:the object.
 ---### Return Value:
 ---		boolean
function IsACDropShip(object) end
