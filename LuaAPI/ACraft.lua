...
---
ACraft.ImpulseDamageThreshold = nil
---### From Parent Class:Actor
---
...
---
ACraft.HitWhatTerrMaterial = nil
------------------------------Properties------------------------------
...
---
ACraft.PlacedByPlayer = nil
---### From Parent Class:SceneObject
---
---    Shows whether this should appear in teh buy menus at all.
---    Buyable or not.
---
ACraft.IsBuyable = nil
---enum value for property:HatchState
ACraft.CLOSED=0
---enum value for property:HatchState
ACraft.OPENING=1
---enum value for property:HatchState
...
ACraft.CLOSING=3
---enum value for property:HatchState
ACraft.HatchStateCount=4
---enum value for property:Side
ACraft.RIGHT=0
---enum value for property:Side
ACraft.LEFT=1
---enum value for property:CraftDeliverySequence
ACraft.FALL=0
---enum value for property:CraftDeliverySequence
ACraft.LAND=1
---enum value for property:CraftDeliverySequence
...
---enum value for property:CraftDeliverySequence
ACraft.UNSTICK=5
---enum value for property:AltitudeMoveState
ACraft.HOVER=0
---enum value for property:AltitudeMoveState
ACraft.DESCEND=1
---enum value for property:AltitudeMoveState
...
---
---None.
function ACraft:CloseHatch()end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:GetController()end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:IsPlayerControlled()end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:IsControllable()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:SetControllerMode(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:SwapControllerModes(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:GetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:SetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:HasObject(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:HasObjectInGroup(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:IsWithinRange(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:AddHealth(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:IsStatus(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:FacingAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:AddAISceneWaypoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:AddAIMOWaypoint(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:ClearAIWaypoints()end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:GetLastAIWaypoint()end
---### From Parent Class:Actor
---### Description:
---
...
---
---How many waypoints.
function ACraft:GetWaypointListSize()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:ClearMovePath()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:AddToMovePathBeginning(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:AddToMovePathEnd(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:RemoveMovePathBeginning()end
---### From Parent Class:Actor
---### Description:
---
...
---
---Whether there was any coordinate to remove. If false, the MovePath is empty.
function ACraft:RemoveMovePathEnd()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None..
function ACraft:AddInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:RemoveInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:SwapNextInventory(p1,p2,p3)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:SwapPrevInventory(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:DropAllInventory()end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:IsInventoryEmpty()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:FlashWhite(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:DrawWaypoints(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:SetMovePathToUpdate()end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:UpdateMovePath(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACraft:SetAlarmPoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:GetAlarmPoint()end
---### From Parent Class:Actor
---### Description:
---
...
function ACraft:RemoveAnyRandomWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:SetRecoil(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:IsRecoiled()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:EnableDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:ForceDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:GibThis(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACraft:MoveOutOfTerrain(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:ApplyForces()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:ApplyImpulses()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:AttachEmitter(p1,p2,p3,p4)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACraft:RemoveWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACraft:IsOnScenePoint(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:EraseFromTerrain()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---String value.
function ACraft:GetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Number (double) value.
function ACraft:GetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Object (Entity *) value.
function ACraft:GetObjectValue()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:SetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ACraft:SetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ACraft:SetObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:RemoveStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:RemoveNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACraft:RemoveObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACraft:StringValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ACraft:NumberValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ACraft:ObjectValueExists(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACraft:SetNextFrame()end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACraft:RotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
---Takes a vector which is offset from the center of this when not rotated or flipped, and then rotates and/or flips it
...
---
---The resulting vector whihch has been flipped and rotated as appropriate.
function ACraft:UnRotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACraft:GetSpriteWidth(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACraft:GetSpriteHeight(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACraft:ReloadScripts()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACraft:GetAltitude(p1,p2)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACraft:SetWhichMOToNotHit(p1,p2,p3)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACraft:IsSetToDelete()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACraft:IsMissionCritical()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACraft:IsHeldDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACraft:IsThrownDevice()end
---### From Parent Class:MovableObject
---### Description:
---
---Indicates whether this MO is made of Gold or not.
...
---
---None.
function ACraft:AddForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds force to this MovableObject for the next time Update() is called.
...
---
---None.
function ACraft:AddAbsForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACraft:AddImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds impulse force (or instant momentum) to this MovableObject for the next time Update() is called.
...
---
---None.
function ACraft:AddAbsImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACraft:ClearForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACraft:ClearImpulseForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACraft:RestDetection()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACraft:NotResting()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACraft:GetGoldValue(p1,p2,p3,p4)end
---### From Parent Class:SceneObject
---### Description:
---
...
---
---None.
function ACraft:SetGoldValue(p1)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ACraft:GetGoldValueString(p1,p2,p3)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ACraft:GetTotalValue(p1,p2,p3)end
---### Description
---Create a new ACraft object in specific module by its present name.
 ---### Arguments:
 ---		present_name: its present name.
 ---		moudle_name: specify the module the object from."All" for not specified 
---### Return Value:
---		the new object
function CreateACraft(present_name,module_name) return ACraft end
---### Description
---Create a new ACraft object randomly in specific group and module.
 ---### Arguments:
 ---		group_name_name: the specific group.
 ---		moudle_name: specify the module the object from."All" for not specified
---### Return Value:
 ---		the new object
function RandomACraft(group_name,module_name) return ACraft end
---### Description
---Clone a ACraft object.
 ---### Arguments:
 ---		object:the object to clone.
 ---### Return Value:
 ---		the cloned object
function CloneACraft(object) return ACraft end
---### Description
---cast a object to ACraft object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToACraft(object) return ACraft end
---### Description
---cast a object to ACraft const object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToConstACraft(object) return ACraft end
---### Description
---tell whether the type of an object is ACraft type.
 ---### Arguments:
 ---		object:the object.
 ---### Return Value:
 ---		boolean
function IsACraft(object) end
