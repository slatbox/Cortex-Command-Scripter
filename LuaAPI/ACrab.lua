...
ACrab.ClassName = nil
---
---    The right BG Leg as an Attachable. This is for Lua binding mostly.
---    A pointer to the Leg Attachable. Ownership is NOT transferred!
---
ACrab.LFGLeg = nil
---
---    The left BG Leg as an Attachable. This is for Lua binding mostly.
---    A pointer to the Leg Attachable. Ownership is NOT transferred!
---
ACrab.LBGLeg = nil
---
---    The right FG Leg as an Attachable. This is for Lua binding mostly.
---    A pointer to the Leg Attachable. Ownership is NOT transferred!
---
ACrab.RFGLeg = nil
---
...
---
ACrab.JetTimeLeft = nil
---
---    Returns whatever is equipped in the turret, if anything. OINT.
---    The currently equipped item, if any.
---
ACrab.EquippedItem = nil
---
...
---
ACrab.FirearmActivationDelay = nil
---
...
---
ACrab.ImpulseDamageThreshold = nil
---### From Parent Class:Actor
---
...
ACrab.DISLODGE=3
---enum value for property:MovementState
ACrab.MOVEMENTSTATECOUNT=4
---enum value for property:Side
ACrab.LEFTSIDE=0
---enum value for property:Side
ACrab.RIGHTSIDE=1
---enum value for property:Side
...
ACrab.SWEEPINGUP=1
---enum value for property:SweepState
ACrab.SWEEPUPPAUSE=2
---enum value for property:SweepState
ACrab.SWEEPINGDOWN=3
---enum value for property:SweepState
ACrab.SWEEPDOWNPAUSE=4
...
---
---None.
function ACrab:ReloadFirearm()end
---### Description:
---
---Tells whether a point on the scene is within close range of the currently used device and aiming status, if
---    applicable.
---### Arguments:
---
...
function ACrab:IsWithinRange(p1)end
---### Description:
---
---Casts an unseen-revealing ray in the direction of where this is facing.
---### Arguments:
---
---Arg1:    The degree angle to deviate from the current view point in the ray casting. A random ray will be chosen out of this
---Arg2:    +-range.
---Arg3:    The range, in pixels, beyond the actors sharp aim that the ray will have.
---
---### Return Value:
---
---Whether any unseen pixels were revealed by this look.
function ACrab:Look(p1,p2,p3)end
---### Description:
---
---Casts an MO detecting ray in the direction of where the head is looking at the time. Factors including head
---    rotation, sharp aim mode, and other variables determine how this ray is cast.
---### Arguments:
---
---Arg1:    The degree angle to deviate from the current view point in the ray casting. A random ray will be chosen out of this
---Arg2:    +-range.
---Arg3:    A specific material ID to ignore (see through)
---Arg4:    Whether to ignore all terrain or not (true means 'x-ray vision').
---
---### Return Value:
---
---A pointer to the MO seen while looking.
function ACrab:LookForMOs(p1,p2,p3,p4)end
---### Description:
---
...
function ACrab:IsOnScenePoint(p1)end
---### Description:
---
...
function ACrab:GetLimbPathSpeed(p1)end
---### Description:
---
...
---
---None.
function ACrab:SetLimbPathSpeed(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:GetController()end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:IsPlayerControlled()end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:IsControllable()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:SetControllerMode(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:SwapControllerModes(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:GetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:SetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:HasObject(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:HasObjectInGroup(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:AddHealth(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:IsStatus(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:FacingAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:AddAISceneWaypoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:AddAIMOWaypoint(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:ClearAIWaypoints()end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:GetLastAIWaypoint()end
---### From Parent Class:Actor
---### Description:
---
...
---
---How many waypoints.
function ACrab:GetWaypointListSize()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:ClearMovePath()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:AddToMovePathBeginning(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:AddToMovePathEnd(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:RemoveMovePathBeginning()end
---### From Parent Class:Actor
---### Description:
---
...
---
---Whether there was any coordinate to remove. If false, the MovePath is empty.
function ACrab:RemoveMovePathEnd()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None..
function ACrab:AddInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:RemoveInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:SwapNextInventory(p1,p2,p3)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:SwapPrevInventory(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:DropAllInventory()end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:IsInventoryEmpty()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:FlashWhite(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:DrawWaypoints(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:SetMovePathToUpdate()end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:UpdateMovePath(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ACrab:SetAlarmPoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:GetAlarmPoint()end
---### From Parent Class:Actor
---### Description:
---
...
function ACrab:RemoveAnyRandomWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:SetRecoil(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:EnableDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:ForceDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:GibThis(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACrab:MoveOutOfTerrain(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:ApplyForces()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:ApplyImpulses()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:AttachEmitter(p1,p2,p3,p4)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACrab:RemoveWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:EraseFromTerrain()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---String value.
function ACrab:GetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Number (double) value.
function ACrab:GetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Object (Entity *) value.
function ACrab:GetObjectValue()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:SetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ACrab:SetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ACrab:SetObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:RemoveStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:RemoveNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ACrab:RemoveObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ACrab:StringValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ACrab:NumberValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ACrab:ObjectValueExists(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACrab:SetNextFrame()end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACrab:RotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
---Takes a vector which is offset from the center of this when not rotated or flipped, and then rotates and/or flips it
...
---
---The resulting vector whihch has been flipped and rotated as appropriate.
function ACrab:UnRotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACrab:GetSpriteWidth(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ACrab:GetSpriteHeight(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACrab:ReloadScripts()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACrab:GetAltitude(p1,p2)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACrab:SetWhichMOToNotHit(p1,p2,p3)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACrab:IsSetToDelete()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACrab:IsMissionCritical()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACrab:IsHeldDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACrab:IsThrownDevice()end
---### From Parent Class:MovableObject
---### Description:
---
---Indicates whether this MO is made of Gold or not.
...
---
---None.
function ACrab:AddForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds force to this MovableObject for the next time Update() is called.
...
---
---None.
function ACrab:AddAbsForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACrab:AddImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds impulse force (or instant momentum) to this MovableObject for the next time Update() is called.
...
---
---None.
function ACrab:AddAbsImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACrab:ClearForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACrab:ClearImpulseForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ACrab:RestDetection()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ACrab:GetGoldValue(p1,p2,p3,p4)end
---### From Parent Class:SceneObject
---### Description:
---
...
---
---None.
function ACrab:SetGoldValue(p1)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ACrab:GetGoldValueString(p1,p2,p3)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ACrab:GetTotalValue(p1,p2,p3)end
---### Description
---Create a new ACrab object in specific module by its present name.
 ---### Arguments:
 ---		present_name: its present name.
 ---		moudle_name: specify the module the object from."All" for not specified 
---### Return Value:
---		the new object
function CreateACrab(present_name,module_name) return ACrab end
---### Description
---Create a new ACrab object randomly in specific group and module.
 ---### Arguments:
 ---		group_name_name: the specific group.
 ---		moudle_name: specify the module the object from."All" for not specified
---### Return Value:
 ---		the new object
function RandomACrab(group_name,module_name) return ACrab end
---### Description
---Clone a ACrab object.
 ---### Arguments:
 ---		object:the object to clone.
 ---### Return Value:
 ---		the cloned object
function CloneACrab(object) return ACrab end
---### Description
---cast a object to ACrab object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToACrab(object) return ACrab end
---### Description
---cast a object to ACrab const object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToConstACrab(object) return ACrab end
---### Description
---tell whether the type of an object is ACrab type.
 ---### Arguments:
 ---		object:the object.
 ---### Return Value:
 ---		boolean
function IsACrab(object) end
