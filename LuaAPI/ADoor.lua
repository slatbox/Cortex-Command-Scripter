...
ADoor.ClassName = nil
---
---The moving door Attachable
---A pointer to the door Attachable of this. Ownership is NOT transferred!
---
ADoor.Door = nil
------------------------------Properties------------------------------
...
---
ADoor.ImpulseDamageThreshold = nil
---### From Parent Class:Actor
---
...
---
ADoor.IsBuyable = nil
---enum value for property:DoorState
ADoor.CLOSED=0
---enum value for property:DoorState
ADoor.OPENING=1
---enum value for property:DoorState
...
---### Return Value:
---
---An int encoding the hatch state. See the DoorState enum.
...
---
---None.
function ADoor:CloseDoor()end
---### Description:
---
---Sets whether this ADoor closes after a while by default (or opens)
---### Arguments:
---
---Arg1:Whether the door by default goes to a closed position. If not, then it will open after a while.
---
---### Return Value:
---
---None.
function ADoor:SetClosedByDefault(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:GetController()end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:IsPlayerControlled()end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:IsControllable()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:SetControllerMode(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:SwapControllerModes(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:GetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:SetAimAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:HasObject(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:HasObjectInGroup(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:IsWithinRange(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:AddHealth(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:IsStatus(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:FacingAngle(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:AddAISceneWaypoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:AddAIMOWaypoint(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:ClearAIWaypoints()end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:GetLastAIWaypoint()end
---### From Parent Class:Actor
---### Description:
---
...
---
---How many waypoints.
function ADoor:GetWaypointListSize()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:ClearMovePath()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:AddToMovePathBeginning(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:AddToMovePathEnd(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:RemoveMovePathBeginning()end
---### From Parent Class:Actor
---### Description:
---
...
---
---Whether there was any coordinate to remove. If false, the MovePath is empty.
function ADoor:RemoveMovePathEnd()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None..
function ADoor:AddInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:RemoveInventoryItem(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:SwapNextInventory(p1,p2,p3)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:SwapPrevInventory(p1,p2)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:DropAllInventory()end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:IsInventoryEmpty()end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:FlashWhite(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:DrawWaypoints(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:SetMovePathToUpdate()end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:UpdateMovePath(p1)end
---### From Parent Class:Actor
---### Description:
---
...
---
---None.
function ADoor:SetAlarmPoint(p1)end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:GetAlarmPoint()end
---### From Parent Class:Actor
---### Description:
---
...
function ADoor:RemoveAnyRandomWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:SetRecoil(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:EnableDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:ForceDeepCheck(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:GibThis(p1,p2,p3)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ADoor:MoveOutOfTerrain(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:ApplyForces()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:ApplyImpulses()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:AttachEmitter(p1,p2,p3,p4)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ADoor:RemoveWounds(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ADoor:IsOnScenePoint(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:EraseFromTerrain()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---String value.
function ADoor:GetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Number (double) value.
function ADoor:GetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---Object (Entity *) value.
function ADoor:GetObjectValue()end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:SetStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ADoor:SetNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Sets the string value associated with the specified key.
...
---
---None.
function ADoor:SetObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:RemoveStringValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:RemoveNumberValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
---
---None.
function ADoor:RemoveObjectValue(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
...
function ADoor:StringValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ADoor:NumberValueExists(p1)end
---### From Parent Class:MOSRotating
---### Description:
---
---Checks whether the value associated with the specified key exists.
...
---
---True if value exists.
function ADoor:ObjectValueExists(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ADoor:SetNextFrame()end
---### From Parent Class:MOSprite
---### Description:
---
...
function ADoor:RotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
---Takes a vector which is offset from the center of this when not rotated or flipped, and then rotates and/or flips it
...
---
---The resulting vector whihch has been flipped and rotated as appropriate.
function ADoor:UnRotateOffset(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ADoor:GetSpriteWidth(p1)end
---### From Parent Class:MOSprite
---### Description:
---
...
function ADoor:GetSpriteHeight(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ADoor:ReloadScripts()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ADoor:GetAltitude(p1,p2)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ADoor:SetWhichMOToNotHit(p1,p2,p3)end
---### From Parent Class:MovableObject
---### Description:
---
...
function ADoor:IsSetToDelete()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ADoor:IsMissionCritical()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ADoor:IsHeldDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ADoor:IsThrownDevice()end
---### From Parent Class:MovableObject
---### Description:
---
---Indicates whether this MO is made of Gold or not.
...
---
---None.
function ADoor:AddForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds force to this MovableObject for the next time Update() is called.
...
---
---None.
function ADoor:AddAbsForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ADoor:AddImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds impulse force (or instant momentum) to this MovableObject for the next time Update() is called.
...
---
---None.
function ADoor:AddAbsImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ADoor:ClearForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ADoor:ClearImpulseForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function ADoor:RestDetection()end
---### From Parent Class:MovableObject
---### Description:
---
...
function ADoor:GetGoldValue(p1,p2,p3,p4)end
---### From Parent Class:SceneObject
---### Description:
---
...
---
---None.
function ADoor:SetGoldValue(p1)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ADoor:GetGoldValueString(p1,p2,p3)end
---### From Parent Class:SceneObject
---### Description:
---
...
function ADoor:GetTotalValue(p1,p2,p3)end
---### Description
---Create a new ADoor object in specific module by its present name.
 ---### Arguments:
 ---		present_name: its present name.
 ---		moudle_name: specify the module the object from."All" for not specified 
---### Return Value:
---		the new object
function CreateADoor(present_name,module_name) return ADoor end
---### Description
---Create a new ADoor object randomly in specific group and module.
 ---### Arguments:
 ---		group_name_name: the specific group.
 ---		moudle_name: specify the module the object from."All" for not specified
---### Return Value:
 ---		the new object
function RandomADoor(group_name,module_name) return ADoor end
---### Description
---Clone a ADoor object.
 ---### Arguments:
 ---		object:the object to clone.
 ---### Return Value:
 ---		the cloned object
function CloneADoor(object) return ADoor end
---### Description
---cast a object to ADoor object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToADoor(object) return ADoor end
---### Description
---cast a object to ADoor const object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToConstADoor(object) return ADoor end
---### Description
---tell whether the type of an object is ADoor type.
 ---### Arguments:
 ---		object:the object.
 ---### Return Value:
 ---		boolean
function IsADoor(object) end
