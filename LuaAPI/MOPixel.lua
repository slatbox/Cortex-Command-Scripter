---## Class
---A movable object with mass that is graphically represented by dynamic drawing stuff.
MOPixel = {}
...
---
MOPixel.HitWhatTerrMaterial = nil
------------------------------Properties------------------------------
...
function MOPixel:ReloadScripts()end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:GetAltitude(p1,p2)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function MOPixel:SetWhichMOToNotHit(p1,p2,p3)end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:IsSetToDelete()end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:IsMissionCritical()end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:IsGeneric()end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:IsHeldDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:IsThrownDevice()end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:HasObject(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:HasObjectInGroup(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function MOPixel:AddForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds force to this MovableObject for the next time Update() is called.
...
---
---None.
function MOPixel:AddAbsForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function MOPixel:AddImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
---Adds impulse force (or instant momentum) to this MovableObject for the next time Update() is called.
...
---
---None.
function MOPixel:AddAbsImpulseForce(p1,p2,p3,p4)end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function MOPixel:ClearForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function MOPixel:ClearImpulseForces()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function MOPixel:RestDetection()end
---### From Parent Class:MovableObject
---### Description:
---
...
---
---None.
function MOPixel:NotResting()end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:MoveOutOfTerrain(p1)end
---### From Parent Class:MovableObject
---### Description:
---
...
function MOPixel:RotateOffset(p1)end
---### From Parent Class:SceneObject
---### Description:
---
...
function MOPixel:GetGoldValue(p1,p2,p3,p4)end
---### From Parent Class:SceneObject
---### Description:
---
...
---
---None.
function MOPixel:SetGoldValue(p1)end
---### From Parent Class:SceneObject
---### Description:
---
...
function MOPixel:GetGoldValueString(p1,p2,p3)end
---### From Parent Class:SceneObject
---### Description:
---
...
function MOPixel:GetTotalValue(p1,p2,p3)end
---### From Parent Class:SceneObject
---### Description:
---
...
function MOPixel:IsOnScenePoint(p1)end
---### Description
---Create a new MOPixel object in specific module by its present name.
 ---### Arguments:
 ---		present_name: its present name.
 ---		moudle_name: specify the module the object from."All" for not specified 
---### Return Value:
---		the new object
function CreateMOPixel(present_name,module_name) return MOPixel end
---### Description
---Create a new MOPixel object randomly in specific group and module.
 ---### Arguments:
 ---		group_name_name: the specific group.
 ---		moudle_name: specify the module the object from."All" for not specified
---### Return Value:
 ---		the new object
function RandomMOPixel(group_name,module_name) return MOPixel end
---### Description
---Clone a MOPixel object.
 ---### Arguments:
 ---		object:the object to clone.
 ---### Return Value:
 ---		the cloned object
function CloneMOPixel(object) return MOPixel end
---### Description
---cast a object to MOPixel object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToMOPixel(object) return MOPixel end
---### Description
---cast a object to MOPixel const object.
 ---### Arguments:
 ---		object:the object to cast.
 ---### Return Value:
 ---		the casted object
function ToConstMOPixel(object) return MOPixel end
---### Description
---tell whether the type of an object is MOPixel type.
 ---### Arguments:
 ---		object:the object.
 ---### Return Value:
 ---		boolean
function IsMOPixel(object) end
